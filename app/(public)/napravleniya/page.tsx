                  ...
                  <div className="grid gap-4 p-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {isValidRoute(`/napravleniya/${direction.slug}`) ? (
                        ...
                        <span className="inline-flex cursor-not-allowed opacity-60 items-center justify-center rounded-xl border border-neutral-200 bg-white px-5 py-2.5 text-sm font-medium text-neutral-400">
                          Подробнее о направлении
                        </span>
                      )}
                      <Link
