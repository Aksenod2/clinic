        ...
        <div className="mx-auto max-w-6xl py-8 lg:py-12">
                ...
                >
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {isValidRoute(`/napravleniya/${direction.slug}`) ? (
                      ...
                      <span className="inline-flex flex-1 cursor-not-allowed opacity-60 items-center justify-center rounded-xl border border-neutral-200 bg-white px-3 py-2 text-xs font-medium text-neutral-400">
                        Подробнее
                      </span>
                    )}
                    <Link
          ...
          >
            <header className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              ...
              <span
                aria-disabled="true"
                className="inline-flex cursor-not-allowed items-center justify-center rounded-xl border border-neutral-200 bg-white px-5 py-2.5 text-sm font-medium text-neutral-400 opacity-60"
              >
                Все отзывы
              </span>
            </header>
