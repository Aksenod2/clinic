                ...
                >
                  ...
                  <div className="mt-auto flex flex-wrap gap-2">
                    {isValidRoute(`/stati/${article.slug}`) ? (
                      ...
                      <span className="inline-flex cursor-not-allowed opacity-60 items-center justify-center rounded-lg border border-neutral-200 bg-white px-4 py-2 text-xs font-medium text-neutral-400">
                        Читать статью
                      </span>
                    )}
